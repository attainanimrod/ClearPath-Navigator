...
set JAVA_HOME=C:\jdk-17\jdk-17
set JAVAFX_HOME=C:\javafx-17\javafx-17
...
javadoc --module-path %JAVAFX_HOME%\lib --add-modules=%JAVAFX_MODULES% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\JavaDocs -subpackages csc2b
IF /I "%ERRORLEVEL%" NEQ "0" (
